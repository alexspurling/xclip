...
static int doIn(Window win, const char *progname) {
...
static void printSelBuf(FILE *fout, Atom sel_type, unsigned char *sel_buf, size_t sel_len) {
#ifdef HAVE_ICONV
